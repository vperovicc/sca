  ...
  return (
    <div>
        ...
        <div className='content_privacy'>
            ...
            <p>Last updated: April 01, 2021<br/><br/>
...
-Country refers to: Serbia<br/><br/>

-Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Smart Consulting Agency PR Nikola Vojtek, Miloja Zakica, 8/4, 11000 Belgrade.<br/><br/>
...
-Terms and Conditions (also referred as "Terms") mean these Terms and Conditions that form the entire agreement between You and the Company regarding the use of the Service.<br/><br/>
...
-Website refers to Smart Consulting Agency, accessible from <a href='https://www.smartconsulting-agency.com/'>https://www.smartconsulting-agency.com/</a><br/><br/>
...
<p>These are the Terms and Conditions governing the use of this Service and the agreement that operates between You and the Company. These Terms and Conditions set out the rights and obligations of all users regarding the use of the Service.<br/><br/>
...
<h1>Termination</h1>
<p>We may terminate or suspend Your access immediately, without prior notice or liability, for any reason whatsoever, including without limitation if You breach these Terms and Conditions.<br/><br/>

Upon termination, Your right to use the Service will cease immediately.</p>
<h1>Limitation of Liability</h1>
<p>Notwithstanding any damages that You might incur, the entire liability of the Company and any of its suppliers under any provision of this Terms and Your exclusive remedy for all of the foregoing shall be limited to the amount actually paid by You through the Service.<br/><br/>
...
<h1>Contact Us</h1>
<p>If you have any questions about these Terms and Conditions, You can contact us:<br/><br/>
